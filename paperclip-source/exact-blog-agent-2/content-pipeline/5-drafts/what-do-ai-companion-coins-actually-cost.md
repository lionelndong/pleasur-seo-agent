...
A coin is a metered unit of media. On Pleasur.ai an AI image or voice note costs 10 coins, a phone call costs 50 coins per minute, and text chat is unlimited — and the tiers run $12.99/mo for 1,500 coins, $27.99/mo for 5,000, and $49.99/mo for 10,000 [link]. Those published numbers let you price out a month before you ever enter a card.

That is the part the category hides. Every "how much does Candy AI cost" review you read ends with the same shrug: tokens, roughly 2–4 per image, confirm in the app. Nobody can tell you what you'll pay, because Candy.ai publishes no per-action token spec [link]. So you sign up, start spending, and find out the price by watching a counter drop. It doesn't have to work that way — once a platform publishes both its coin allowance *and* the cost of each action, you can do the arithmetic up front instead of discovering it after.
...
[VISUAL:type=image;sub=concept-illustration;prompt=Simple labeled diagram titled "How a companion coin is spent". One coin icon on the left labeled "1 coin". Three arrows out to three labeled boxes: "AI image = 10 coins", "Voice note = 10 coins", "Phone call = 50 coins / minute". A fourth greyed box labeled "Text messages = 0 coins (unlimited)". Clean editorial illustration, white background, sans-serif labels, brand-neutral colors, no people.;style=illustration;safety=sfw]

## What an AI companion "coin" actually is

An AI companion coin is a prepaid credit that pays for one piece of generated media. On Pleasur.ai a coin costs the same on every tier: an AI image is 10 coins, a voice note is 10 coins, a phone call is 50 coins per minute, and text chat is unlimited. Plans run $12.99/mo for 1,500 coins, $27.99/mo for 5,000, and $49.99/mo for 10,000 [link].
...
Start with Starter. 1,500 coins buys up to ~150 images, or ~150 voice notes, or ~30 minutes of calls — or any mix of the three [link]. Step up to Standard and 5,000 coins covers ~500 images or ~100 call-minutes. Ultimate's 10,000 coins doubles that again: ~1,000 images or ~200 call-minutes.
...
[VISUAL:type=screenshot;target=generate;what=in-chat coin balance decrementing by 10 after an image generation;annotate=.coin-counter]
...
*Text messages are unlimited on every tier; only images, voice notes, and calls spend coins.*

This is information no page-1 result has, because Candy.ai publishes no per-action spec to do the math from. Compare what an opaque allowance gets you. Candy.ai's published subscription runs about $12.99/mo month-to-month (advertised as low as ~$5.99/mo on an annual plan) and includes a monthly token allowance [link]. Third-party reviews peg the spend at a reviewer-estimated 2–5 tokens per image [link] — so a typical monthly allowance lands somewhere between ~20 and ~50 images, and you can't price a call at all, because no per-minute rate is published anywhere. Pleasur.ai's 1,500 published coins buys a countable ~150 images or ~30 call-minutes. The dollar figures may land in the same ballpark; the *knowability* doesn't. One you can plan around. The other you discover after the fact.
...
[VISUAL:type=chart;data=research.pleasurai_annual_equiv_monthly_usd;style=bar;title=Monthly vs annual-billed price per tier (Pleasur.ai)]
...
An opaque model publishes the allowance but not the rate. So reviewers fill the gap with estimates — ~2–4 tokens an image, ~3 tokens a call-minute, always flagged "indicative only, confirm in-app" — and you find out the real cost by spending. Every competitor token figure in the table below is **reviewer-estimated, not vendor-published** [link]. Candy.ai, by a 2025 review's own account, publishes its subscription price but not a canonical per-action spec [link].
...
*Competitor figures are reviewer estimates, not vendor-published specs [link].*
...
**Step 3 — decide monthly vs annual** based on how long you'll realistically keep using it, then re-check the live price page, since rates change [link].
...
[VISUAL:type=image;sub=diagram;prompt=Three-step horizontal flow diagram titled "Calculate your monthly companion cost". Box 1 "Estimate monthly use" with small icons for image, voice, call. Arrow to Box 2 "Multiply by published coin cost (10 / 10 / 50)". Arrow to Box 3 "Pick the cheapest tier that covers it". Clean editorial illustration, white background, sans-serif labels, no people.;style=illustration;safety=sfw]
...
Plans run from $12.99/mo at the entry tier to $49.99/mo at the top tier on Pleasur.ai [link]. Your real cost depends on how much metered media — images, voice notes, calls — you use on top of unlimited text.
...
On Pleasur.ai: an image is 10 coins, a voice note is 10 coins, and a phone call is 50 coins per minute [link]. Those rates are published and identical on every tier.
...
Trials require a card and cancel anytime [link]. Check the live statement descriptor and refund window before subscribing, and read the renewal terms so a trial doesn't roll over unexpectedly.
