...
- Pleasur.ai pricing $12.99 / $27.99 / $49.99 + coin metering (10 coins/image, 5,000-coin Standard) → `pleasur.ai/pricing` (first-party; values match the dossier's live re-fetch this run).
- CrushOn AI Free $0 / Standard $4.90 / Premium $7.90 + 100 free credits + 8K→16K memory → `crushon.ai/pricing` (first-party; confirmed live in the research dossier this run via Firecrawl. Direct WebFetch returned HTTP 403/bot-walled this run, so the dossier's first-party trace is the citation of record — the price is NOT reviewer-sourced).
- DreamGen $7.83 / $19.35 / $48.30 (regular) + 5K–30K context → `v2.dreamgen.com/pricing` (first-party; re-verified live this run — page also shows a limited-time intro discount, but the regular prices stated match the dossier).
