...
1. **Joi base price corrected.** The draft carried "$13.99–$17.77/mo." No source supports $13.99 — reviewers cite a premium plan at **$17.77/mo** ([aigirlfriendscout](https://www.aigirlfriendscout.com/reviews/joi-ai)) dropping to **~$5/mo annual** ([scribehow](https://scribehow.com/page/Joi_AI_Review__I_Tried_It_for_5_Days_Heres_What_Happened__xWlr5h8TQkiR-JNxnJ3yIQ)). Corrected in the intro and the table-baseline line. The table cell still reads "~$17.77/mo (reviewer)"; verify it matches.
2. **Joi image-cost estimate cut.** The draft's "$10–15 a month extra for regular image use" was not supported by the cited reviews (they give per-companion Neurons cost, not a monthly image estimate). Removed; the well-sourced 1,000-Neuron/$20-per-companion figure is kept.
3. **genfindr 7.6/10 reframed.** The genfindr [review](https://genfindr.com/blog/pleasur-ai-review-2026) publishes a **7.6/10 OVERALL** score, not a distinct memory sub-score. The draft's "rates Pleasur.ai's memory 7.6/10" was a misattribution; reframed to "scores it 7.6/10 overall, singling out memory/context retention" (the review does praise context retention in prose). Number is real and load-bearing; framing now matches the source.
4. **OurDream price + bundle framing corrected.** Draft table cell read "~$12.99/mo" with no source; corrected to **~$9.99/mo annual (~$19.99/mo)** per [aigirlfriendscout](https://www.aigirlfriendscout.com/reviews/ourdream-ai) and a [scribehow review](https://scribehow.com/page/OurDream_AI_Review_2026_I_Tested_It_Honest_Verdict__6gJ6HyNJSFOU0aXdGfZEGQ). Reviewers DISAGREE on whether media is truly "all included" vs DreamCoin-metered within the plan; the "one price, everything on" assertion was softened to attributed, two-sided framing with a "not strictly uncapped" caveat rather than presenting flat-rate as fact. Media-billing column updated to "Bundle plan + in-app coins."
...
- Pleasur.ai pricing ($12.99/$27.99/$49.99, $5.20 annual) and coin costs (10/10/50) verified live against [pleasur.ai/pricing](https://pleasur.ai/pricing) this run — exact match, no false first-party fact. Privacy claims cite [pleasur.ai/legal/privacy-policy](https://pleasur.ai/legal/privacy-policy).
