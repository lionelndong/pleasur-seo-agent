...
![a clean editorial diagram of a single chat conversation flowing into four stacked, labeled memory layers from top to bottom: "Context window (short-term)", "Saved fact list", "Pinned notes", "Long-term understanding"](images/ai-companion-memory/image-1-a-clean-editorial-diagram-of-a.png)
...
![Memory type table](images/ai-companion-memory/table-pub-1.png)
...
![a diagram showing a fixed-width frame labeled "context window" sliding to the right across a long vertical list of chat message bubbles, with the oldest bubbles at the top falling out of the frame and fading](images/ai-companion-memory/image-2-a-diagram-showing-a-fixed-widt.png)
...
![A representative user post describing their AI companion forgetting earlier conversations after an update](images/ai-companion-memory/external-3-a-representative-user-post-des.png)
...
![Test table](images/ai-companion-memory/table-pub-2.png)
...
![a clean comparison table graphic titled "AI companion memory compared" with five app rows and columns for memory type, cross-session recall, user-editable memory, and notable limit](images/ai-companion-memory/image-4-a-clean-comparison-table-graph.png)
...
![App table](images/ai-companion-memory/table-pub-3.png)
...
![Tier table](images/ai-companion-memory/table-pub-4.png)
...
![the AI Companion Creator showing the personality and backstory fields](images/ai-companion-memory/screenshot-6-the-ai-companion-creator-showi.png)
