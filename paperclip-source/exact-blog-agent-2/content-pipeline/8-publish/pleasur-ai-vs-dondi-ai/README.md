# Publish package — Pleasur.ai vs Dondi.ai (2026): Honest Comparison
...
2. Title: Pleasur.ai vs Dondi.ai (2026): Honest Comparison
3. Slug: pleasur-ai-vs-dondi-ai
4. Description (≤80 chars): Dondi.ai is a flat-rate NSFW AI companion that independent reviewers currently
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py pleasur-ai-vs-dondi-ai --publish
```
