# Publish package — How to Talk Dirty: A Confident Beginner's Guide (18+)
...
2. Title: How to Talk Dirty: A Confident Beginner's Guide (18+)
3. Slug: dirty-talking
4. Description (≤80 chars): Most people freeze the first time they try dirty talk.
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py dirty-talking --publish
```
...
## Stats
- Word count: 139
- Description length: 54 chars (cap 80)
