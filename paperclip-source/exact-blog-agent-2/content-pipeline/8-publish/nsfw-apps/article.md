...
<!-- VISUAL-TODO: [VISUAL:type=external;sub=serp;url=https://www.google.com/search?q=nsfw+apps;selector=#search;crop=padded;what=Google results for "nsfw apps" showing mixed app categories;annotate=the different result types] -->
...
![Pleasur.AI monthly coins by paid tier](images/nsfw-apps/chart-2-pleasur-ai-monthly-coins-by-pa.png)

Now compare allowance with spend.

![Coin cost by metered action](images/nsfw-apps/chart-3-coin-cost-by-metered-action.png)
...
![Pleasur.AI companion setup controls for appearance, personality, backstory, and conversation style](images/nsfw-apps/screenshot-4-pleasur-ai-companion-setup-con.png)
...
![Pleasur.AI image generation style and prompt controls](images/nsfw-apps/screenshot-5-pleasur-ai-image-generation-st.png)
...
![In-chat voice and call controls](images/nsfw-apps/action-6-log-in-with-the-saved-session.png)
...
![Candy AI product page showing paid companion positioning](images/nsfw-apps/external-7-candy-ai-product-page-showing.png)
...
![Nastia product page showing adult companion feature breadth](images/nsfw-apps/external-8-nastia-product-page-showing-ad.png)
...
![NSFW tools directory showing many listings](images/nsfw-apps/external-9-nsfw-tools-directory-showing-m.png)
...
<!-- VISUAL-TODO: [VISUAL:type=external;sub=serp;url=https://www.google.com/search?q=does+apple+allow+nsfw+apps;selector=#search;crop=padded;what=Google results showing iPhone and app-store availability questions;annotate=the iPhone and app-store wording] -->

Then check the storefront rule itself.

<!-- VISUAL-TODO: [VISUAL:type=external;sub=news-quote;url=https://developer.apple.com/app-store/review/guidelines/;selector=#safety;crop=padded;what=Apple App Store Review Guidelines safety section;annotate=the objectionable-content policy language] -->
